...
class Tab1SwipeHelperCallback(private val recyclerViewAdapter:Tab1Adapter) : ItemTouchHelper.Callback(){
...
//        recyclerViewAdapter.swapData(fromPos, toPos)
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View = viewHolder.itemView.findViewById(R.id.tab1_item_view)
